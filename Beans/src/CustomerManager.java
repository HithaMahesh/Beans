...
public class CustomerManager {
    public static void main(String[] args) {
        ...
        customers.add(new Customer(1, 1000.50, "Alexa", "Siri"));
        customers.add(new Customer(2, 1500.75, "Alexa", "Ish"));
        customers.add(new Customer(3, 900.00, "Inch", "Sam"));
        customers.add(new Customer(4, 1200.25, "Alexa", "Siri"));
        customers.add(new Customer(5, 800.00, "Charlie", "Ish"));
